...
function changeColorBack (){ 
    sayHelloButton.classList.remove("black"); 
}
    ...
    axios.get('http://localhost:3000/animals')
        .then(res =>{
            ...
            for (i=0; i <res.data.length;i++){
                let newFoodList = document.createElement("p");
                newFoodList.textContent=res.data[i];
                document.querySelector("body").appendChild(newFoodList)
            }
        })
}
...
document.getElementById("query-button").addEventListener("click",queryCheck)
////////////////
//INTERMEDIATE//
////////////////
...
//     let newFoodList = document.createElement("li");
//     let newFood = document.createElement("span");
//     newFood.textContent=char;
//     newFoodList.appendChild(newFood)
//     document.querySelector("body").appendChild(newFoodList)
//   }
...
const createFood = (event)=> {
    ...
    let newFoodList = document.createElement("li");
    let newFood = document.createElement("span");
    newFood.textContent=foodInput.value;
